...
function JJPower() {
    ...
    JJPower.getValueByProgress = function (startValue, endValue, t) {
    ...
    /** Inline Style **/
    JJPower.prototype.jjSetLeft = function (num) {
        this.style.left = num + 'px';
        this.jjTotallyUnreliableLeft = num;
        return this;
    };
    ...
    /** Animation **/
    JJPower.prototype.jjAnimateScroll_horizontal = function (shiftPixel, animationDuration, endFunction, isLinear, timingArr) { // Frame function runs each frame, and takes the current progress param!
        let me = this;
        let origScrollLeft = me.scrollLeft;
        me.jjAnimate(scrollFrame, animationDuration, endFunction, isLinear, timingArr);

        /* Inner Function */
        function scrollFrame(t) {
            let scrollLeft = JJPower.getValueByProgress(origScrollLeft, origScrollLeft + shiftPixel, t);
    ...
    JJPower.easeInTiming = function (t, timingArr, timingLen) {
        ...
        let retT = JJPower.getValueByProgress(timingArr[base], timingArr[next], real - base);
        return retT;
    };
