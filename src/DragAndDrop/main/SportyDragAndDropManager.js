function SportyDragAndDropManager() {
    ...
    /** Public APIs **/
    this.makeMyKidsDraggable = function (targetContainerI, scrollDivI = targetContainerI) {
    ...
    function checkShouldDisregard(element) {
        ...
        let undraggableElement = genUtil.getClosestPapa(element, 'button', '.ddDraggable');

        return undraggableElement;
    }
}